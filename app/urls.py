...
path('asistente/parametros', ParametroList.as_view() ,name='parametros'),
path('asistente/parametros/update/<pk>', editParametros.as_view() ,name='edit_parametros'),
...
path('asistente/paralelo/add', addParalelo.as_view() ,name='addParalelo'),
...
path('asistente/asignacioncursos/add', AsignacionCursosAdd.as_view() ,name='asignacion_c_add'),
