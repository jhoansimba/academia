...
class Talento_Humano (models.Model):
    imagen_th = models.ImageField(null=True, upload_to='images/talento_humano', verbose_name='Fotografía')
    ...
    Titulos= models.FileField(upload_to=TitulosAcreditados, verbose_name='5. Título que acredite su profesión')
    Experiencia= models.FileField(upload_to= ExperienciaLaboral, verbose_name='6. Certificados de experiencia laboral')
    Cursos= models.FileField(upload_to= CertificadosCapacitacion, verbose_name='7. Certificados de eventos de capacitación en los ultimos 5 años')
    Historial= models.FileField(upload_to= HistorialLaboral, verbose_name='8. Impresión de historial Laboral ')
    CarnetDiscap= models.FileField(upload_to=CarnetDiscapacidad, verbose_name='9. Copia de carnet de discapcidad ')
    CertiBancaria= models.FileField(upload_to=CertificacionBancaria, verbose_name= '10. Certificación Bancaria de la institucion financiera que corresponda')
